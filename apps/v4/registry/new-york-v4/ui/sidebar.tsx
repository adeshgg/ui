...
function SidebarProvider({
  ...
  defaultOpen?: boolean
  /**
   * The open state of the sidebar for controlled components.
   */
  open?: boolean
  /**
   * Callback fired when the open state of the sidebar changes.
   */
  onOpenChange?: (open: boolean) => void
  /**
   * If true, the sidebar will expand on hover when in the `icon` collapsible state.
   * @default false
   */
